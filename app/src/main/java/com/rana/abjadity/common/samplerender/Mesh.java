...
import com.rana.abjadity.common.samplerender.IndexBuffer;
...
public class Mesh implements Closeable {
  ...
  private final com.rana.abjadity.common.samplerender.VertexBuffer[] vertexBuffers;
   ...
   */
  public Mesh(
          com.rana.abjadity.common.samplerender.SampleRender render,
      PrimitiveMode primitiveMode,
      IndexBuffer indexBuffer,
          com.rana.abjadity.common.samplerender.VertexBuffer[] vertexBuffers) {
   ...
   * (location 2, vec3).
   */
  public static Mesh createFromAsset(com.rana.abjadity.common.samplerender.SampleRender render, String assetFileName) throws IOException {
    try (InputStream inputStream = render.getAssets().open(assetFileName)) {
      ...
      com.rana.abjadity.common.samplerender.VertexBuffer[] vertexBuffers = {
        new com.rana.abjadity.common.samplerender.VertexBuffer(render, 3, localCoordinates),
        new com.rana.abjadity.common.samplerender.VertexBuffer(render, 2, textureCoordinates),
        new com.rana.abjadity.common.samplerender.VertexBuffer(render, 3, normals),
      };
