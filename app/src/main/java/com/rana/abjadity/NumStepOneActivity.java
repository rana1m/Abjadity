...
public class NumStepOneActivity extends AppCompatActivity {
    ...
    public void onBackPressed() {
        super.onBackPressed();
        Intent i = new Intent(NumStepOneActivity.this,MapActivity.class);
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        forward.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent i = new Intent(NumStepOneActivity.this, NumStepTowActivity.class);
                i.putExtra("childId",childId);
                i.putExtra("isNum","num");
                i.putExtra("parentId",parentId);
                i.putExtra("childLevel",childLevel);
                i.putExtra("button",button);
                startActivity(i);
    ...
    public void winningFunction() {
        ...
        AlertDialog.Builder builder = new AlertDialog.Builder(NumStepOneActivity.this);
