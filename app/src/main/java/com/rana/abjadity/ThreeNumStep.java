...
public class ThreeNumStep extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        forward.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                //Toast.makeText(getApplicationContext(),button+" message",Toast.LENGTH_LONG).show();
                winningFunction();
            }
        });
    ...
    public void winningFunction() {
        ...
        AlertDialog.Builder builder = new AlertDialog.Builder(ThreeNumStep.this);
        ...
        SaveButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent i = new Intent(ThreeNumStep.this,StepFourNumActivity.class);
                i.putExtra("childId",childId);
                i.putExtra("parentId",parentId);
                i.putExtra("childLevel",childLevel);
                i.putExtra("button",button);
